			...
			<div className="min-h-screen p-4 md:p-6 manrope">
				...
				<main className="flex justify-center">
					<div className="w-full md:w-3xl lg:w-5xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
						<DemoCard
							header="Base Usage"
							child={<TextHighlight>Hello World</TextHighlight>}
						/>
						<DemoCard
						...
						<DemoCard
							...
							child={<TextHighlight duration={600}>Hello World</TextHighlight>}
						/>
						<DemoCard
							header="Custom Styling"
							child={
								<TextHighlight className="space-mono font-bold text-xl p-2 cursor-pointer">
									Hello World
								</TextHighlight>
							}
						/>
