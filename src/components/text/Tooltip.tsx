...
const Tooltip = ({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies(calculatePosition): only call once
	useEffect(() => {
		if (isHovering) {
	...
	const getPopupClasses = () => {
		const baseClasses =
			"z-50 rounded-md shadow-lg border border-gray-200 transition-opacity duration-200";
