...
const DualSlider = ({
	...
	return (
		<div className={twMerge("relative w-full py-4", className)}>
			{showLabels && (
				<div className="flex justify-between mb-2">
					<span className={twMerge("text-sm text-gray-500", labelClassName)}>
						{formatLabel(min)}
					</span>
					<span className={twMerge("text-sm text-gray-500", labelClassName)}>
						{formatLabel(max)}
			...
			<div
				ref={trackRef}
				className={twMerge("h-2 w-full rounded-full bg-gray-200", trackClassName)}
			>
				{/* Selected range */}
				<div
					className={twMerge(
